...
public class MailerBean {
    ...
    public Future<String> sendVerificationMail(String email, String key,String cin, String password) {
        ...
        try {
            ...
            message.setSubject("Message de confirmation de demande de préinscription en Diplôme DUESS");
            ...
            String htmlContent = "<html><body><h1>Message de confirmation de candidature</h1>"
                    + "<p>Bonjour</p>"
                    + "<p>Vous avez entamez la procédure de candidature au diplôme DUESS a la <strong>Faculté des Sciences Juridiques Economiques et Sociales</strong> d'Oujda<br />"
                    ...
                    + "http://preinsmasterdroit.ump.ma/canduess/compte/validation.xhtml?key="+key+"<br />"
 ...
 @Asynchronous
    public Future<String> sendConfirmationCandidatureMail(String email, String branche) {
        ...
        try {
            ...
            String htmlContent = "<html><body><h1>Message de confirmation de candidature</h1>"
                    + "<p>Bonjour</p>"
                    + "<p>Vous avez effectué votre choix de candidature au diplôme DUESS <strong>Faculté des Sciences Juridiques Economiques et Sociales</strong> dans les filières suivantes : " + branche + "<br /></p>"
