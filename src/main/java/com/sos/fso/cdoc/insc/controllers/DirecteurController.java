 ...
 * @author master05
 */
@Named(value = "directeurController")
@SessionScoped
public class DirecteurController implements Serializable{
   // ======================================
    // = Attributes =
    // ======================================
    private static final Logger logger = Logger.getLogger(DirecteurController.class.getName());
    ...
    public static class PersonControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            DirecteurController controller = (DirecteurController) facesContext.getApplication().getELResolver().
